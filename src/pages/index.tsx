...
import { SeverityToggle } from '~/components/findings/severity-toggle';
...
const Home: NextPage = () => {
  ...
  const [hideHigh, setHideHigh] = useState(false);
        ...
        <div className="flex h-full w-full flex-col text-white">
          <div className="flex w-full flex-row py-4">
            <div className="flex flex-1 justify-start gap-2">
              ...
              <SeverityToggle
                sval={'critical'}
                activated={hideCritical}
                onToggle={setHideCritical}
              />
              <SeverityToggle
                sval={'high'}
                activated={hideHigh}
                onToggle={setHideHigh}
              />
              <SeverityToggle
                sval={'medium'}
                activated={hideMedium}
                onToggle={setHideMedium}
              />
              <SeverityToggle
                sval={'low'}
                activated={hideLow}
